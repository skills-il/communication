...
שימו לב:
- 14 הימים שבחוק הם המועד למסירת **הודעת הביטול**, לא למשלוח הפיזי של המוצר. בחוק אין מועד קבוע להחזרה הפיזית.
- הזיכוי יבוצע תוך 14 ימים **ממועד קבלת הודעת הביטול**, ולא ממועד קבלת המוצר חזרה.
...
> **סניפו את התבנית לפי עילת הביטול לפני ששולחים אותה.** התבנית למעלה מתאימה לביטול **שלא מחמת פגם** (סעיף 14ה(ב)): הצרכן מחזיר את המוצר למקום העסק, ומותר לגבות דמי ביטול של עד 5% או 100 ש"ח, הנמוך מביניהם.
> אם הביטול הוא **מחמת פגם, אי-התאמה, אי-אספקה במועד או הפרה אחרת של העוסק** (סעיף 14ה(א)), הכללים הפוכים: הצרכן רק מעמיד את המוצר לרשות העוסק **במקום שבו נמסר לו** ומודיע על כך, העוסק אוסף על חשבונו, **ואסור לגבות דמי ביטול כלשהם**. סעיף 14ה(ד) מגדיר דמי ביטול ככוללים הוצאות משלוח ואריזה, ולכן גם גלגול דמי המשלוח על הצרכן במקרה כזה הוא גבייה אסורה. במקרה הזה יש למחוק את שורת דמי הביטול ואת הוראות המשלוח ולכתוב שאתם אוספים את המוצר.
> בשני המקרים, סעיף 14ה מחייב גם למסור לצרכן **עותק מהודעת ביטול החיוב**, לא רק לזכות אותו.
...
בהתאם לסעיף 14ג(ד) לחוק הגנת הצרכן, החריגים לזכות הביטול בעסקת מכר מרחוק הם:
- טובין פסידים
- שירותי הארחה, נסיעה, חופש או בילוי, אם מועד הביטול חל בתוך שבעה ימים שאינם ימי מנוחה לפני מועד מתן השירות
