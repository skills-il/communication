...
- בישראל חוקי ספאם מחמירים (תיקון 40 לחוק התקשורת). שליחת SMS ללא הסכמה דורשת opt-in מפורש מראש, לא רק opt-out. סוכנים עלולים להמליץ על תהליכי opt-out שמפרים את החוק הישראלי.
