...
This is a Skills IL category repository containing AI agent skills for communication needs in Israel. Each subdirectory is a self-contained skill following the open Agent Skills standard.
...
├── israeli-sms-gateway/        # Skill: Israeli SMS Gateway
